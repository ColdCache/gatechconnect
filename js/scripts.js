...
// ];
var userData = [
  {id:1,criteriaName:'Age',approved:true,points:34},
  {id:2,criteriaName:'Race',approved:true,points:4},
  {id:3,criteriaName:'Schedule',approved:true,points:56},
  {id:4,criteriaName:'WorkType',approved:false,points:14},
  {id:5,criteriaName:'Gender',approved:false,points:100},
  {id:6,criteriaName:'Skill',approved:false,points:0},
  // {id:7,criteriaName:'Jeff',approved:true,points:8},
  // {id:8,criteriaName:'Betty',approved:true,points:18},
  // {id:9,criteriaName:'Krista',approved:true,points:10},
  // {id:11,criteriaName:'Devin',approved:false,points:3},
  // {id:12,criteriaName:'Navid',pproved:true,points:57},
  // {id:13,criteriaName:'Bhat',approved:false,points:314},
  // {id:14,criteriaName:'Nuper',approved:true,points:94}
];
function ctrlDualList($scope) {
  ...
  $scope.listA = userData.slice(0,0);
  $scope.listB = userData.slice(0,5);
...
function openList1() {
    var teamlist = document.getElementById("panel-391734");
    var ungroupedlist = document.getElementById("ungroupedlist")

    if (teamlist.style.visibility== "hidden"){
        teamlist.style.visibility ="visible";
        // teamlist.style.visibility = "hidden"
        ungroupedlist.style.visibility= "hidden";
    }
    // else{
...
function closeList1() {
    ...
    if (teamlist.style.visibility == "visible"){
        teamlist.style.visibility = "hidden";
        ungroupedlist.style.visibility= "visible";
    }
    // else{
    //     // teamlist.style.display = "all";
